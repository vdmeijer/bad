...
<section class="main-section" id="brabantse-airsoft-division"><!--main-section-start-->
    <div class="container">
        <h2>Brabantse Airsoft Division</h2>
        <h6>BAD is een airsoft team gevestigd in Noord-Brabant.</h6>
        <div class="row">
            <div class="col-lg-4 col-sm-6 wow fadeInLeft delay-05s">
                <div class="service-list">
                    ...
                    <div class="service-list-col2">
                        <h3>Kleding</h3>
                        <p>Wij hebben geen kledingcode maar de meeste leden gebruiken de A-tacs au camoflage.</p>
                    </div>
                </div>
                <div class="service-list">
                    <div class="service-list-col1">
                    ...
                    <div class="service-list-col2">
                        <h3>Gameplay</h3>
                        <p>Zowel op het veld als daar buiten zijn we informeel en leggen wij onze prioriteiten op eenn leuke dag. Wij focussen ons dan ook voornamelijk op plezier en een eerlijk spel.</p>
                    </div>
                </div>
                <div class="service-list">
                    <div class="service-list-col1">
                    ...
                    <div class="service-list-col2">
                        <h3>Locaties</h3>
                        <p>We beperken onszelf niet tot bepaalde locaties, hoewel individuele leden hun voorkeuren hebben voor bepaalde terreinen en organisaties.</p>
                    </div>
                </div>
            </div>
